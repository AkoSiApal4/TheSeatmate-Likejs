...
const data = [
  {
    ...
    image: require("../../assets/study-hub.jpg"), // Update with correct path
    initialRating: 0,
  },
  {
    id: "2",
    ...
    image: require("../../assets/smart-work.jpg"), // Update with correct path
    initialRating: 0,
  },
  {
    id: "3",
    ...
    image: require("../../assets/d-study-hub.jpg"), // Update with correct path
    initialRating: 0,
  },
];
  ...
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      ...
      <View style={styles.imageContainer}>
        ...
        <Text style={styles.heart} onPress={() => toggleLike(item.id)}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerText}>SeatMate</Text>
      </View>
      {/* Content */}
      <FlatList
        data={data}
